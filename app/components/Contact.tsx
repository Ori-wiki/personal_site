...
function ContactString() {
  ...
  return (
    <div
      ref={wrapRef}
      className='contact-string relative hidden h-[470px] w-full max-w-[620px] lg:block'
    >
      <canvas ref={canvasRef} className='contact-string__canvas' />
      <div ref={cursorRef} className='contact-string__cursor' />
    </div>
  );
}
          ...
          <div className='mt-10 flex flex-col items-start gap-4 text-3xl font-black tracking-tight text-white sm:text-[34px]'>
            <div className='flex max-w-full items-center gap-3'>
              ...
              <button
                ...
                className={`copy-email-button shrink-0 ${
                  copiedTelegram ? 'is-active' : ''
                }`}
                onClick={copyTelegram}
                type='button'
              >
                <span className='copy-email-button__top' />
                <span className='copy-email-button__bottom' />
              </button>
            </div>
            <div className='flex max-w-full items-center gap-3'>
              <a
